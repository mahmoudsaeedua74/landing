...
export default function Banner() {
  return (
    <div
      ...
      className="bg-second-color z-20 translate-y-12 text-center  m-4 sm:m-0 c text-white py-16 md:py-24 lg:py-40 px-4 md:px-12 lg:px-40 rounded-t-[40px] md:rounded-t-[60px] lg:rounded-t-[100px]"
    >
